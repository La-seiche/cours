...
var longue = phrases[0];

for(var index = 0; index < phrases.length; index++){
  if (longue.length < phrases[index].length){
    longue = phrases[index];
  }
}

document.write("<p>La phrase la plus longue est : <strong>" + longue + "</strong>et sa longueur est de : " + longue.length + "</p>");
